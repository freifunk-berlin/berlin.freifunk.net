...
<script type="text/javascript">
  /* Configure at https://www.betterplace.org/en/manage/projects/157408-freifunk-berlin/iframe_donation_form/new */
  var _bp_iframe        = _bp_iframe || {};
  _bp_iframe.project_id = 157408; /* REQUIRED */
  _bp_iframe.lang       = 'de'; /* Language of the form */
  _bp_iframe.width = 600; /* Custom iframe-tag-width, integer */
  _bp_iframe.color = 'ffb400'; /* Button and banderole color, hex without "#" */
  _bp_iframe.background_color = 'ffffff'; /* Background-color, hex without "#" */
  _bp_iframe.default_amount = 20; /* Donation-amount, integer 1-99 */
  _bp_iframe.recurring_interval = 'monthly'; /* Interval for recurring donations, string out of single, monthly, and yearly */
